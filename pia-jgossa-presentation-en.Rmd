---
title: "The french excellence initiative in figures"
author:
- Julien Gossa\newline
- Maître de conférences\newline
- Université de Strasbourg, Laboratoires SAGE UMR 7363 et ICube UMR 7357\newline
- gossa@unistra.fr
subtitle: More money, or different money?
output:
  beamer_presentation:
    slide_level: 2
    theme: "Madrid"
...
- Distributed by the _Agence Nationale de la Recherche_ (ANR)
...
- For universities: « Transforming » projects
  - for instance: _Ecoles universitaires de recherche_ (EUR = ITI)
  - but especially : 
...
- 2021 : Interview AEF Juppé : « ___We have been able to avoid sprinkling. [...] 
...
- Link between PIA and mergers
  - IGAENR: little benefit in terms of teaching or research [@philippe_bezagu_premier_2019]
  - Very expensive

\ 

- Context : reform of the distribution of SCSPs (Subventions pour Charge de Service Public)
