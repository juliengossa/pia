...
- Lien PIA - restructurations (notamment les fusions)
  - IGAENR : peu d'avantages en termes d'enseignement ou de recherche [@philippe_bezagu_premier_2019]
  - Nécessite beaucoup de moyens

\ 

- Contexte : réforme de la distribution des SCSP (Subventions pour Charge de Service Public)
  - 1994 - 2005 : SanREMO (Système analytique de Répartition des Moyens)
  - 2007 : LRU et RCE (Responsabilités et compétences élargies) [@pacale_aime_etude_2012] 
...
### IDEX et ISITE = Ressources additionnelles + Labellisation des établissements ?
- ~~Des moyens en plus~~
- __Un moyen de plus de différencier les établissements__
